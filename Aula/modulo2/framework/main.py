...
def hello_world():
    ...
    <html>
        <head>
            <title>Fatos sobre dependencia tecnológica.</title>
        </head>
        <body>
            <h1>Fato aleatório</h1>
            <p>{random.choice(lista_de_fatos)}</p>
            <p>Atualize a página para ter um novo fato que seja totalmente diferente.</p>
        </body>
    </html>
"""
